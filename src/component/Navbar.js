          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ">
              <li className="nav-item">
                <Link className="nav-Link active mx-3" aria-current="page" to={`/`} style={{ textDecoration: 'none', color: `${props.mode === 'light' ? 'black' : 'white'}` }}>Home</Link>
              </li>
              <li className="nav-item">
                <Link
                  className="nav-Link"
                  to="/About"
                  style={{ textDecoration: 'none', color: `${props.mode === 'light' ? 'black' : 'white'}` }}>
                  About
                </Link>
